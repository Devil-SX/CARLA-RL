...
class CarlaEnv(Env):
    ...
    def __init__(self):
        ...
        self.action_space = spaces.Box(0,0.5,shape=(1,),dtype=np.float32)
        self.observation_space = spaces.Box(0,20,shape=(1,),dtype=np.float32) # Speed
    ...
    #     thr_array = np.linspace(0,0.5,20)
